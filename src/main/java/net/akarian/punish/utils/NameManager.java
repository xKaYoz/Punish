...
public class NameManager {
    ...
    private static final HashMap<UUID, HashMap<String, Object>> cache = new HashMap<>();
    ...
    public void startCacheTimer() {
        Bukkit.getScheduler().scheduleSyncRepeatingTask(Punish.getInstance(), new Runnable() {
            @Override
            public void run() {
